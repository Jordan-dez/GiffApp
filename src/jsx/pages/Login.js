...
function Login (props) {
  const [email, setEmail] = useState('admin@admin.com');
    ...
    function onLogin(e) {
        ...
        if (email === '') {
            errorObj.email = "L'adresse mail est requise";
            error = true;
        }
        if (password === '') {
		...
		<div className="authincation d-flex flex-column flex-lg-row flex-column-fluid">
			<div className="login-aside text-center  d-flex flex-column flex-row-auto">
				<div className="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
					...
					<h3 className="mb-2">Bienvenue sur GF APP</h3>
							...
							<div className="col-xl-12 tab-content">
								<div id="sign-in" className="auth-form   form-validation">
									...
									<form onSubmit={onLogin}  className="form-validate">
										<h3 className="text-center mb-4 text-black">Se connecter</h3>
									...
									<div className="new-account mt-3">
										<p>Vous n'avez pas de compte? <Link className="text-primary" to="./page-register">inscrivez-vous</Link></p>
									</div>
								</div>
							</div>
						</div>
